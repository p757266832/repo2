    ...
    <script type="text/javascript">
        $(function() {
            ...
            $('#dataList').datagrid({
                ...
                method: "post",
                /*这里有问题*/
                url:"${path}/grade/gradeList?t="+new Date().getTime(),
                idField:'id',
            ...
            $("#delete").click(function(){
                ...
                if(selectLength == 0){
                    ...
                    $.messager.confirm("消息提醒", "如果年级下存在班级将无法删除,请先删除班级信息", function(r){
                        if(r){
                            $.ajax({
                                type: "post",
    ...
    <form id="addForm" method="post">
        <table id="addTable" cellpadding="8">
            <tr >
                <td>年级名:</td>
                <td>
                    <input id="add_names"  class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="name" data-options="required:true, missingMessage:'请填写年级名'"  />
                </td>
            </tr>
            <tr>
                <td>备注:</td>
    ...
    <form id="updateForm" method="post">
        <table id="editTable" border=0  cellpadding="8">
            ...
            <tr>
                <td>年级:</td>
                <td>
                    <input id="update_name"  class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="name" data-options="required:true, validType:'repeat', missingMessage:'请输入年级名'" />
                </td>
            </tr>
            <tr>
                <td>备注:</td>
