...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${path}/resources/easyui/css/default.css" />
	...
	<script type="text/javascript" src='${path}/resources/easyui/js/outlook2.js'> </script>
	 ...
	 var _menus = {"menus":[
	                 <c:if test="${userType == 1}">
						{"menuid":"1","icon":"","menuname":"用户（管理员）管理",
							"menus":[
							    /*在这里找问题*/
									{"menuid":"11","menuname":"用户列表","icon":"icon-user-teacher","url":"${path}/user/list"}
								]
						},
                      </c:if>
                        {"menuid":"3","icon":"","menuname":"年级信息管理",
                             "menus":[
                                 {"menuid":"31","menuname":"年级列表","icon":"icon-world","url":"${path}/grade/list"},
                             ]
                         },
                         {"menuid":"4","icon":"","menuname":"班级信息管理",
                             "menus":[
                                 {"menuid":"41","menuname":"班级列表","icon":"icon-house","url":"${path}/clazz/list"},
                             ]
                         },
						{"menuid":"2","icon":"","menuname":"学生信息管理",
							"menus":[
									{"menuid":"21","menuname":"学生列表","icon":"icon-user-student","url":"${path}/student/list"},
								]
						}
				]};
...
<body class="easyui-layout" style="overflow-y: hidden"  scroll="no">
    ...
    <div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
        ...
        <span style="float:right; padding-right:20px;" class="head"><span style="color:red; font-weight:bold;">${admin.username}&nbsp;</span>您好&nbsp;&nbsp;&nbsp;<a href="${path}/admin/exitUser" id="loginOut">安全退出</a></span>
        <span style="padding-left:10px; font-size: 16px; ">学生信息管理系统</span>
    </div>
    <div region="south" split="true" style="height: 30px; background: #D2E0F2; ">
        <div class="footer">Copyright &copy; gaowenbo By bobo</div>
    </div>
